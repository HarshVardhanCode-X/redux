  ...
  return (
    <>
      ...
      <div className='flex flex-col items-center justify-evenly'>
        {/* <h1 className='flex text-blue-900 text-[50px]'>Redux Implementation</h1>
        <h2 className='flex text-gray-500 text-[30px]'>Items in the cart - {cart}</h2>
        <button className='bg-green-800 w-[150px] border border-black text-white rounded-full p-2'
          onClick={handleADD}>Add Item</button>
        <button className='bg-red-500 w-[150px] border border-black1 text-white rounded-full p-2' onClick={handleREMOVE}>Remove Item</button> */}
